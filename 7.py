...
# ===================================================================================
#      灵感记忆系统 (MuseBox) v2.2 - 最终修复版
# ===================================================================================
# 功能:
# - 【【【 v2.2 核心修复: 修正了 'true' is not defined 的语法错误 】】】
...
# ==============================================================================
def setup_systems():
    print("="*10 + " 灵感记忆系统 (MuseBox) v2.2 正在启动 " + "="*10)
...
def setup_local_llm():
    ...
    try:
        ...
        llm = ChatOpenAI(openai_api_base="http://127.0.0.1:8087/v1", openai_api_key="na", model_name="local", temperature=0.2, max_tokens=4096, request_timeout=60, max_retries=1)
        llm.invoke("Hi")
...
def trigger_capture_task(loop):
    ...
    try:
        # <<< 【【【 核心修复 】】】: 将 text=true 修改为 text=True
...
def main():
    ...
    print("\n" + "="*70)
    print("  ✅ [系统就绪] MuseBox 后台服务已启动 (最终修复版)")
