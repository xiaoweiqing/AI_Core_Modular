# ==============================================================================
#      Bilingual Dialogue Turn Builder v7.1 - Stabilized & Hardened
# ==============================================================================
# Version Notes:
...
def setup_vector_database():
    ...
    try:
        ...
        # # Health Check (Temporarily disabled for compatibility)
        # QDRANT_CLIENT.health_check()
        # print(f"   {Colors.GREEN}-> Qdrant connection successful.{Colors.ENDC}")
...
# --- 6. Data Recording Workflow (Alt+S, Alt+D, Alt+C) ---
def save_input(text):
...
def create_hotkey_handler(target_func, *args):
    def handler():
        if target_func.__name__ == "cancel_last_turn":
            target_func()
            return
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("      Bilingual Dialogue Turn Builder v7.1 - Stabilized & Hardened")
    print("=" * 70)
